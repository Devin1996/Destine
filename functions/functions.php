				...
				<div class='row'>
					...
					<div id='posts' class='col-sm-6'>
						<div class='row'>
							...
							<div class='col-sm-6'>
								<h3><a stylr='text-decoration:none; cursor:pointer;color:#3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3> 
						...
						<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-info'>ASK</button></a><br>
					</div>
					<div class='col-sm-3'>
					</div>
				</div><br><br>				
