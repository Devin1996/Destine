...
<div class="row">
	...
	<div class="col-sm-8">
          ...
          echo "
					...
					<ul class='nav pull-left' style='position: absolute;top: 10px;left: 40px;'>
				    	<li class='dropdown'>
							...
							<div class='dropdown-menu'>
				                ...
				                <button name='submit' class='btn btn-default' >Update cover</button>
				            	</center>
				            </div>
				        </li>
				    </ul>
         	...
         	<div id='profile_img'>
	            <img src='users/$c_image' alt='Profile' class='img-circle' width='180px' height='185px' />
           ...
           <?php 
            ...
            if(isset($_POST['submit'])){
              ...
              if($u_cover==''){
                ...
                echo "<script>window.open('cprofile.php?c_id=$c_id','_self')</script>";
                exit();
              }else{
              
              move_uploaded_file($image_tmp,"cover/$u_cover.$random_number");
              
              $update = "update company set c_cover='$u_cover.$random_number' where c_id='$c_id'";
          ...
          <?php 
            ...
            if(isset($_POST['update'])){
              ...
              if($u_image==''){
                ...
                echo "<script>window.open('cprofile.php?c_id=$user_id','_self')</script>";
                exit();
              }else{
              ...
              $update = "update company set c_image='$u_image.$random_number' where c_id='$c_id'";
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #e6e6e6; text-align: center; left:0.8%; border-radius: 5px;">
		...
		<p><strong>Email: </strong>  $c_email</p><br>
	...
	<div class="col-sm-6">
		...
		<?php
			...
			$get_posts = "select * from cposts where user_id='$u_id' ORDER by 1 DESC LIMIT 5";
			...
			$get_posts = "select c_email from company where c_id='$c_id'";
			...
			echo"
				<a href='cp_view.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'>View</button></a>
				<a href='cedit_post.php?post_id=$post_id' style='float:right;'><button  class='btn'>Edit</button></a>
