...
<body>
  ...
  <div class="row">
    <div id="insert_post" class="col-sm-12">
      <center>
      <form action="comfeed.php?id=<?php echo $c_id; ?>" method="post" id="f" enctype="multipart/form-data">
        
    <textarea class="form-control" id="content" rows="4" name="content" placeholder="Market your Service"></textarea><br>
    <label class="btn btn-warning" id="upload_image_button">Select banner
    <input type="file" name="upload_image" size="30"></label>
          
    <button  style="background-color:#393939;" id="btn-post" class="btn btn-info btn-lg" name="pub">Publish</button>
      </form>
      <?php cinsertPost(); ?> 
    </center>
    </div>
