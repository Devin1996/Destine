...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to Induvidual service Provider Account</strong></h3>				
			</div>
			<div class="1-part">
				<form action="" method="post">
					...
					<a style="text-decoration: none;float: right; color: #393939;" data-toggle="tooltip" title="Create Account!" href="induvidual_reg.php">Don't have an account?</a><br><br>
					
					<center><button id="signin" class="btn btn-info btn-lg" name="login">Login</button></center>
					<?php include("in_log_q.php"); ?>
				</form>
			</div>   
		</div>
	</div>
